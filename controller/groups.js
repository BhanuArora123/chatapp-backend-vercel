...
exports.addGroup = async (req, res, next) => {
    ...
    if (req.files) {
        ...
        groupIcon = await mod.posixPath("https://chatappbackend123456.herokuapp.com/" + req.files.groupIcon[0].path)
    }
    if (!groupIcon) {
        groupIcon = `https://chatappbackend123456.herokuapp.com//images/custom.jpg`
    }
